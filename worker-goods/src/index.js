...
const BOOKS = { materials: "materials_v1", furnishings: "furnishings_v1", hoa: "hoa_v1", elements: "elements_v1", swatches: "swatches_v1" };
  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (b.type === "submit") {
        ...
        if (["materials", "furnishings", "plants", "hoa", "elements", "swatches"].indexOf(book) < 0) return json({ ok: false, error: "unknown book" }, 400);
