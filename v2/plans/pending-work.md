...
## Current status: isolated account work only
Live remains V2.032 (db39746). V2.030/031 server changes were rolled back in production. This branch is a restricted test foundation, NOT a completed release. See server-storage.md for the data ownership contract, known limitations and ordered test gates. No real user login or production cutover is complete.
