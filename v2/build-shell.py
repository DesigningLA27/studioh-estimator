...
(root/'index.html').write_text('<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Studio H · V2 Preview</title><link rel="stylesheet" href="src/shell.css"></head><body>'+mock+'<div id="v2-notice" hidden role="status"></div><script src="src/shell.js?v=7"></script><link rel="stylesheet" href="src/workspace.css?v=7"><script src="src/icons.js"></script><link rel="stylesheet" href="src/libraries.css?v=7"><script src="src/libraries.js?v=7"></script><script src="src/workspace.js?v=7"></script></body></html>')
